...
**Qué sucede:**
1. El servidor inicia en `http://localhost:20261`
...
**Error:**
```
Error: listen EADDRINUSE: address already in use :::20261
```

**Solución 1: Mata el proceso existente**

```bash
# Encuentra proceso usando el puerto 20261
lsof -i :20261
