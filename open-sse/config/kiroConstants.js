 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what devlens needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a devlens
...
/**
 * Detect whether a model id refers to a devlens synthetic agentic variant.
...
/**
 * Detect whether a model id is a devlens synthetic thinking variant
...
/**
 * Resolve a devlens model id to the real upstream Kiro model id, plus flags
