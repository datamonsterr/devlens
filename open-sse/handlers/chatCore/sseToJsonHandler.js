...
import { saveRequestDetail, appendRequestLog } from "@/lib/db";
 ...
 */
export async function handleForcedSSEToJson({ providerResponse, sourceFormat, provider, model, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, authContext, clientRawRequest, onRequestSuccess, trackDone, appendLog }) {
