...
El dashboard se abrirá automáticamente en tu navegador en `http://localhost:20261`

**Configuración por defecto:**
- **Dashboard**: `http://localhost:20261`
- **API Endpoint**: `http://localhost:20261/v1`
...
El puerto de API (20261) y el puerto del dashboard (3000) están configurados en la aplicación. Para cambiarlos, necesitarás modificar el código fuente o usar variables de entorno si se soportan.
...
Si el puerto 20261 o 3000 ya está en uso:
