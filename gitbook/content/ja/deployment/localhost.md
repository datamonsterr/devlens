...
ダッシュボードが自動的にブラウザで `http://localhost:20261` に開きます。

**デフォルト設定:**
- **ダッシュボード**: `http://localhost:20261`
- **APIエンドポイント**: `http://localhost:20261/v1`
- **データディレクトリ**: `~/.9router`
...
APIポート(20261)とダッシュボードポート(3000)はアプリケーションで設定されています。変更するにはソースコードを修正するか、サポートされている場合は環境変数を使用してください。
