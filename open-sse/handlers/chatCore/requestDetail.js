...
export function saveUsageStats({ provider, model, tokens, connectionId, apiKey, authContext, rtkTokensSaved = 0, endpoint, label = "USAGE" }) {
  ...
  saveRequestUsage({
    ...
    tokens: normalized,
    timestamp: new Date().toISOString(),
    teamId: authContext?.teamId || undefined,
