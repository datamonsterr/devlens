...
describe("PR #1175 - integration with compressMessages", () => {
  ...
  it("npm install output above MIN_COMPRESS_SIZE → compressed", async () => {
  ...
  it("input below MIN_COMPRESS_SIZE → NOT compressed", async () => {
  ...
  it("compressed output never grows input (safety guard)", async () => {
  ...
  it("tool_result with is_error:true is NOT compressed (preserve error traces)", async () => {
