 ...
 * API. They are devlens fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic devlens variant set for a single upstream Kiro model.
 *
 ...
 * into devlens variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
