...
export const PROVIDERS = {
  claude: {
    ...
    clientId: process.env.CLAUDE_OAUTH_CLIENT_ID || "placeholder",
    tokenUrl: "https://api.anthropic.com/v1/oauth/token"
  },
  gemini: {
    baseUrl: "https://generativelanguage.googleapis.com/v1beta/models",
    format: "gemini",
    clientId: process.env.GEMINI_OAUTH_CLIENT_ID || "placeholder",
    clientSecret: process.env.GEMINI_OAUTH_CLIENT_SECRET || "placeholder"
  },
  "gemini-cli": {
    baseUrl: "https://cloudcode-pa.googleapis.com/v1internal",
    format: "gemini-cli",
    clientId: process.env.GEMINI_CLI_OAUTH_CLIENT_ID || "placeholder",
    clientSecret: process.env.GEMINI_CLI_OAUTH_CLIENT_SECRET || "placeholder"
  },
  codex: {
    ...
    clientId: process.env.CODEX_OAUTH_CLIENT_ID || "placeholder",
    tokenUrl: "https://auth.openai.com/oauth/token"
  },
  qwen: {
    baseUrl: "https://portal.qwen.ai/v1/chat/completions",
    format: "openai",
    clientId: process.env.QWEN_OAUTH_CLIENT_ID || "placeholder",
  ...
  iflow: {
    ...
    clientSecret: process.env.IFLOW_OAUTH_CLIENT_SECRET || "placeholder",
  ...
  qoder: {
    ...
    clientSecret: process.env.QODER_OAUTH_CLIENT_SECRET || "placeholder",
  ...
  antigravity: {
    ...
    clientId: process.env.ANTIGRAVITY_OAUTH_CLIENT_ID || "placeholder",
    clientSecret: process.env.ANTIGRAVITY_OAUTH_CLIENT_SECRET || "placeholder"
  },
  openrouter: {
  ...
  "kimi-coding": {
    ...
    format: "claude",
    headers: { ...CLAUDE_API_HEADERS },
    clientId: process.env.KIMI_OAUTH_CLIENT_ID || "placeholder",
  ...
  xai: {
    ...
    format: "openai",
    clientId: process.env.XAI_OAUTH_CLIENT_ID || "placeholder",
