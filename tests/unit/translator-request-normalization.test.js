...
describe("request normalization", () => {
  it.skip("claudeToOpenAIRequest flattens text-only content arrays into string", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it.skip("filterToOpenAIFormat flattens text-only arrays to string", () => {
    const body = {
      messages: [
        {
          role: "user",
  ...
  it.skip("translateRequest keeps /v1/messages Claude->OpenAI text payloads string-safe", () => {
    const body = {
  ...
  it.skip("parseSSELine supports provider raw NDJSON stream lines", () => {
