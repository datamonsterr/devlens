...
export async function getUsageHistory(filter = {}) {
  ...
  const rows = await db.all(`SELECT timestamp, teamId, userId, provider, model, connectionId, apiKey, endpoint, cost, status, tokens FROM usageHistory ${where} ORDER BY id ASC`, params);
