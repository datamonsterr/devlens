...
🎉 **El dashboard se abre automáticamente** en `http://localhost:20261`
...
Settings → Models → Advanced:
  OpenAI API Base URL: http://localhost:20261/v1
...
```json
{
  "anthropic_api_base": "http://localhost:20261/v1",
...
```bash
export OPENAI_BASE_URL="http://localhost:20261"
