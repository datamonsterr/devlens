# dashboard-navigation-cleanup Specification

## Purpose

Keep dashboard navigation and settings focused on documented Devlens capabilities by excluding legacy 9router/local-app actions and obsolete settings.
