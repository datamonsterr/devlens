...
Dashboard sẽ tự động mở trong trình duyệt tại `http://localhost:20261`
...
Port API (20261) và port dashboard (3000) được cấu hình trong application. Để đổi, bạn cần sửa source code hoặc dùng biến môi trường nếu được hỗ trợ.
...
Nếu port 20261 hoặc 3000 đã được dùng:
